 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(I,B){var K=I.length;I.push(B);e:for(;0<K;){var te=K-1>>>1,_e=I[te];if(0<r(_e,B))I[te]=B,I[K]=_e,K=te;else break e}}function n(I){return I.length===0?null:I[0]}function i(I){if(I.length===0)return null;var B=I[0],K=I.pop();if(K!==B){I[0]=K;e:for(var te=0,_e=I.length,Oe=_e>>>1;te<Oe;){var q=2*(te+1)-1,re=I[q],me=q+1,xe=I[me];if(0>r(re,K))me<_e&&0>r(xe,re)?(I[te]=xe,I[me]=K,te=me):(I[te]=re,I[q]=K,te=q);else if(me<_e&&0>r(xe,K))I[te]=xe,I[me]=K,te=me;else break e}}return B}function r(I,B){var K=I.sortIndex-B.sortIndex;return K!==0?K:I.id-B.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],f=1,h=null,d=3,p=!1,x=!1,y=!1,m=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function _(I){for(var B=n(c);B!==null;){if(B.callback===null)i(c);else if(B.startTime<=I)i(c),B.sortIndex=B.expirationTime,e(l,B);else break;B=n(c)}}function v(I){if(y=!1,_(I),!x)if(n(l)!==null)x=!0,H(P);else{var B=n(c);B!==null&&j(v,B.startTime-I)}}function P(I,B){x=!1,y&&(y=!1,u(A),A=-1),p=!0;var K=d;try{for(_(B),h=n(l);h!==null&&(!(h.expirationTime>B)||I&&!b());){var te=h.callback;if(typeof te=="function"){h.callback=null,d=h.priorityLevel;var _e=te(h.expirationTime<=B);B=t.unstable_now(),typeof _e=="function"?h.callback=_e:h===n(l)&&i(l),_(B)}else i(l);h=n(l)}if(h!==null)var Oe=!0;else{var q=n(c);q!==null&&j(v,q.startTime-B),Oe=!1}return Oe}finally{h=null,d=K,p=!1}}var C=!1,R=null,A=-1,E=5,S=-1;function b(){return!(t.unstable_now()-S<E)}function T(){if(R!==null){var I=t.unstable_now();S=I;var B=!0;try{B=R(!0,I)}finally{B?k():(C=!1,R=null)}}else C=!1}var k;if(typeof g=="function")k=function(){g(T)};else if(typeof MessageChannel<"u"){var X=new MessageChannel,W=X.port2;X.port1.onmessage=T,k=function(){W.postMessage(null)}}else k=function(){m(T,0)};function H(I){R=I,C||(C=!0,k())}function j(I,B){A=m(function(){I(t.unstable_now())},B)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(I){I.callback=null},t.unstable_continueExecution=function(){x||p||(x=!0,H(P))},t.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<I?Math.floor(1e3/I):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(I){switch(d){case 1:case 2:case 3:var B=3;break;default:B=d}var K=d;d=B;try{return I()}finally{d=K}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(I,B){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var K=d;d=I;try{return B()}finally{d=K}},t.unstable_scheduleCallback=function(I,B,K){var te=t.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?te+K:te):K=te,I){case 1:var _e=-1;break;case 2:_e=250;break;case 5:_e=1073741823;break;case 4:_e=1e4;break;default:_e=5e3}return _e=K+_e,I={id:f++,callback:B,priorityLevel:I,startTime:K,expirationTime:_e,sortIndex:-1},K>te?(I.sortIndex=K,e(c,I),n(l)===null&&I===n(c)&&(y?(u(A),A=-1):y=!0,j(v,K-te))):(I.sortIndex=_e,e(l,I),x||p||(x=!0,H(P))),I},t.unstable_shouldYield=b,t.unstable_wrapCallback=function(I){var B=d;return function(){var K=d;d=B;try{return I.apply(this,arguments)}finally{d=K}}}})(Wm);Gm.exports=Wm;var j_=Gm.exports;/**
 * @license React
...
`)+`
`+u);const _=g+m+o,v=g+u+a,P=am(r,r.VERTEX_SHADER,_),C=am(r,r.FRAGMENT_SHADER,v);r.attachShader(y,P),r.attachShader(y,C),n.index0AttributeName!==void 0?r.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function R(b){if(t.debug.checkShaderErrors){const T=r.getProgramInfoLog(y).trim(),k=r.getShaderInfoLog(P).trim(),X=r.getShaderInfoLog(C).trim();let W=!0,H=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(W=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,y,P,C);else{const j=lm(r,P,"vertex"),I=lm(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
